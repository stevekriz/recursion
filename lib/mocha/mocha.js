(function () {
  ...
  require.register("ms.js", function (module, exports, require) {
    ...
    function parse(str) {
      var m = /^((?:\d+)?\.?\d+) *(ms|seconds?|s|minutes?|m|hours?|h|days?|d|years?|y)?$/i.exec(
        str
      );
      if (!m) return;
  ...
  require.register("reporters/base.js", function (module, exports, require) {
    ...
    Base.prototype.epilogue = function () {
      ...
      if (stats.failures) {
        fmt =
          color("bright fail", "  " + exports.symbols.err) +
    ...
    function errorDiff(err, type, escape) {
      return diff["diff" + type](err.actual, err.expected)
        .map(function (str) {
          if (escape) {
            str.value = str.value
              .replace(/\t/g, "<tab>")
      ...
      runner.on("test end", function (test) {
        ...
        if ("passed" == test.state) {
          var el = fragment(
            ...
            test.title,
            test.duration,
            encodeURIComponent(test.fullTitle()) + window.location.hash
          );
  ...
  require.register(
    ...
    function (module, exports, require) {
      ...
      function Teamcity(runner) {
        ...
        runner.on("test", function (test) {
          console.log(
            "##teamcity[testStarted name='" + escape(test.fullTitle()) + "']"
          );
        });
